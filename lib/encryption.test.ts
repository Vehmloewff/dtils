...
Deno.test({
	...
	async fn() {
		...
		const encrypted = await encrypt(key, stringToBinary(text))
		const decrypted = binaryToString(await decrypt(key, encrypted))
...
Deno.test({
	...
	async fn() {
		const text = `Lots of emojis in here: 🌍 📦 🚇 ⬇️ 🌽 🔳 🕡 📅 💱 🐦 🛎 🔛 🌠 🐚 🤑 🏳 🗃 👄 🎆 ♈️ ⛺️ 🍐 🔃 ☂ 📋 🏀 💶 👟 🏍 ❇️ 📻 🌚 🚧 🕣 👘 🚏 ☦ 💞 👃 🏕 🕌 📑 🙏 🚯 📪 🏗 ✖️ 🌯 🕯 🙍 📝 😡 🏟 🔧 🔚 🤘 🐮 🛁 👙 🚌 💚 🐫 🚽 📟 🚬 🏇 📏 🔅 🏖 ☠ 🐣 🍙 😬 💲 🔸 🎦 🈁 🚶 Ⓜ️ 📼 🐛 🚎 🚴 💛 🔖 ✔️ 💒 😅 🔹 🕙 🗾 👋 😣 ⛏ 👎 ✏️ 🔈 🚛 🍼 🐢 ⚗ ⛱ 🍖 🐿 🔰 ⏭ ⛈ ⚔ ☸ 🌝 🍜 🎲 🅰️ 🏙 😲 🆒 🚟 ↙️ 👕 🐯 💖 🍍 💸 ⛹ 🙃 🧀 🏨 💬 ⚖ 🌞 ⛄️ 🔜 ⛓ 💭 🌿 👅 🚩 ✒️ 🐕 🔓 ☝️ ⏬ 🎻 ⚫️ 🔉 🌓 🔶 ⛸ 🏔 1️⃣ 🍒 💃 🚦 🚕 🐠 🏺 👚 💻 🍤 ⏲ 🕤 ♠️ 🎌 👊 🎊 🕉 💰 🎂 ☁️ 📫 🕷 👓 ⛽️ 🍴 🎾 🈹 🚖 ⬜️ 4️⃣ 🎢 🏎 🚆 7️⃣ ♓️ 📢 🐻 🚥 🌁 🍓 ✨ 🖼 🛋 🏡 🌵 😽 🏁 🚝 🚹 🖨 ⛅️ 🔠 🍄 😟 🌪 🎁 ✂️ 😧 ⌨ 📞 🔢 🔥 ⛪️ 🔴 👧 💝 *⃣ 🕊 🖲 📴 👖 🌈 ♏️ 2️⃣ 🐙 ☮ 💅 🍕 🎣 🐥 8️⃣ 🎉 😮 📈 🍳 ♿️ 😱 🌮 🔣 🐋 🌬 📗 🌋 ✅ 🕶 🤐 👮 🐺 🕥 🕓 🙋 🍇 📛 😋 🍲 😾 🐼 6️⃣ 🚾 😑 ⏰ 🗳 ♊️ 🍻 ©️ 🌌 🚰 🔡 🕔 📣 🉐 ✈️ ⚒ 🆑 💨 🙌 😹 📚 ⛩ 🕎 🚠 ⁉️ 🃏 ▶️ 😀 🗑 🕴 🐧 🔐 🌥 ↪️ 🏛 👨 🎍 🌰 ⬆️ 🚃 😈 🙇 😩 🎪 👠 🏐 🐸 ℹ️ 🍶 📳 🎸 ▫️ 💍 🙅 🛤 🐨 🗨 🚺 ⭐️ 🍟 ♍️ 🍈 🌾 🍘 ❎ 💾 🎐 🔗 🙀 🍊 👛 👥 👡 🔫 💣 🔘 🐳 📄 ⛴ 😎 🏥 😊 ☄ 🗓 💴 📃 👱 📒 📥 🕧 😼 💼 🐓 🍺 🐬 🐎 🔟 🗞 🏂 🌡 🚼 🍱 😜 ⏏ 📌 🎤 🛂 😍 🔞 💪 🌼 🤔 🉑 🏊 🐌 ⚙ 🌸 🚲 🤖 🐍 👾 🕋 🏫 🛅 😇 🎏 🏑 🗣 ‼️ ⏺ 🌶 💘 📡 🔩 📓 🐩 🚵 ➕ 📍 👩 ⚪️ ⛳️ 🎃 🛃 🖍 👂 🌃 🏄 🎼 🚳 ⏪ 👫 🌺 🎥 🕕 ⚓️ 🚷 🎳 ◀️ 🕦 🚙 🈴 📷 🌷 🍛 ☢ 💵 ☣ 🌻 ♣️ 🛬 ✳️ 🔌 🏈 🛌 ↕️ 📨 🚈 ⚡️ ✍ 🌜 🎠 🚄 😯 🍣 ➗ 💯 🏣 📬 💤 😿 ↔️ ➰ 🎎 🏩 🏴 🎿 🚚 😵 🌏 💡 🛡 📰 ↖️ 🍢 🌫 👀 ⏳ ❌ 🍮 💗 😝 🏪 🕸 🎗 🏷 ♉️ 🤗 🕵 🎨 🎴 🐰 ✊ 💥 🦂 🎇 🔻 🍝 🐊 👽 👼 🍋 🐷 💂 ™️ 🆙 🚫 🦀 🍹 👈 ⚜ 🐡 🤕 🔤 🔊 ◼️ 🌦 💷 🍌 😞 🤓 🔼 🚒 🎹 🍡 📿 ⚾️ 🏯 🌟 🏏 🏋 🙂 😠 🈷️ 🖖 😖 🆘 〰️ 👦 🔽 ⛲️ 🎋 🌙 🚑 🚗 🔂 🚢 🏰 👿 👝 ⛎ 🐪 😆 ♑️ 💕 🔕 ❕ 🚓 🌛 📕 🀄️ ↗️ 👸 🌔 🖱 ⏯ 😕 👜 ✌️ 🏉 🔪 📆 🍫 ☺️ 👇 🍸 🔮 🕟 🈺 🔍 🗡 ⤵️ 🌐 🛍 ☔️ 🍁 🖐 🌄 📖 👁 🍞 😴 🏘 💦 ✴️ 🐱 💩 👢 🍆 🔺 🗒 ☹ 💑 9️⃣ 🕰 📔 😦 🏠 👏 ⚠️ 🌨 🚊 🌖 😻 👭 😙 🔏 🕖 🎀 🆚 💉 😭 🌱 🕞 😰 🍵 🛫 🚉 🍑 🌹 🍿 👪 🌩 🚻 🔲 🚮 🐏 🎩 🅱️ 🏝 🈯️ 📩 🕠 ♒️ 🍯 💁 🛏 😓 🍂 🚡 🌂 📁 🐶 ❔ 🍅 🙄 ◻️ 🌊 🍗 🈂️ ❣ 😃 🚪 👔 🛐 🌴 📲 💳 👐 ⏱ 😘 🅿️ 🔑 📭 🅾️ ⏫ ⬛️ 💐 🎧 🗼 🗽 🐭 🚁 🌑 🤒 ✉️ 💋 🗿 🏢 ⏩ 📠 💽 🌀 🌲 🏤 🐒 🔔 🕜 📉 🌉 🎛 ↘️ 🚿 🕹 ⚱ 📱 🔄 🚍 🚂 🐔 3️⃣ 🚨 🕗 💈 👶 🖌 🎭 🛀 🎟 🐉 🌎 🙆 👆 🖇 ⌛️ 🔆 💙 🈲 🎙 🚸 🙎 👵 🕳 ⌚️ 💹 🛣 ⏮ 🎓 💓 🚅 🏭 🗻 🍨 🍔 🌭 ♦️ ⤴️ 🐟 🎈 🔀 🚐 🈚️ ®️ ☃ 5️⃣ ☕️ 👻 📂 👌 ⛔️ 🍧 🎷 🗂 🖕 🖊 🌘 😚 🐁 ◾️ 🙊 🎺 🐽 🏜 😶 😔 👹 👉 😸 🗺 🐖 💿 🆕 🎡 🦄 ♐️ 😂 🍥 ㊙️ 🏅 🐐 🎫 🎞 🆗 🐆 📶 😄 🍠 📧 📸 ✋ 🏒 🔇 🐗 💇 🌕 👬 💜 🎰 🎅 🚱 🏆 🐃 🍦 ♋️ ⛑ 🌗 🌅 🆖 💟 👤 🚀 😢 💧 🍉 💢 🐑 ☑️ 🍪 🎬 ↩️ 🗜 🍽 ♻️ 🌆 👞 😌 🔒 🏃 🚜 📯 👗 🛩 🚣 🖥 😒 📊 🈸 💊 👣 🎶 💀 ⬅️ 📎 🔁 🌤 🙈 💏 ㊗️ ⏹ 🕚 💎 📇 🍚 🏚 😳 🎑 🛥 🕘 🖋 📘 ⛰ 🎖 📽 🗝 ➿ 🏌 📀 ▪️ 🕛 😺 🕐 👑 🐲 🐾 ☯ 🚔 ◽️ 😁 🈵 🐹 🐄 🏞 🎮 🗯 🍾 🔦 🛰 🍬 👳 ⚛ ⚰ 🐵 🔯 🕒 🐂 🗄 🍏 😗 〽️ 🐞 📙 🆓 0️⃣ ♥️ ☀️ 💠 🔋 🌧 🎱 🌒 🏮 😪 🏸 🐜 💄 🏧 📵 🏹 ⚽️ 👴 🎚 👺 ✡ ☘ ♌️ ☎️ ♨️ 🕝 📤 🎄 ⛵️ 🌇 💫 📐 🍰 😥 🛢 📺 👷 👲 👍 🍭 ⏸ 🐈 🆔 🍷 🍎 🏓 😷 🔬 🚤 🙁 🍀 👯 🐇 🔭 😨 🎽 🎯 💮 ❄️ 🦁 ❗️ 🏬 🈶 🙉 🔙 ⭕️ ⛷ 🕢 🛄 🍩 🆎 🦃 🚭 🔷 📜 🈳 😛 😏 ✝ 💌 ☪ 🔨 🐅 😉 #️⃣ ♎️ 🛳 🕑 🎵 😐 😤 🌳 🏵 👰 💺 🚋 🔵 🔝 👒 🕍 💆 🛠`
		const key = await generateKey()
...
Deno.test({
	...
	async fn() {
		...
		const encrypted = await encrypt(pair.publicKey, stringToBinary(text))
		const decrypted = binaryToString(await decrypt(pair.privateKey, encrypted))
